...
class SimpleMappingTest {
    ...
    @Test
    fun testSimpleMappingNewData() {
        // request succeed, no local data
    ...
    @Test
    fun testSimpleMappingOldAndNewData() {
        // request succeed, local data exists
        val request = Request.Success("newData")
    ...
    @Test
    fun testSimpleMappingErrorWithOldData() {
        // request failed, local data exists
    ...
    @Test
    fun testSimpleMappingBuilderErrorWithOldData() {
        // request failed, local data exists (another builder)
        val request = Request.Error<String>(NoSuchElementException())
